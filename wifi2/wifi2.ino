...
SoftwareSerial Teste(6, 7); //PINOS QUE EMULAM A SERIAL, ONDE O PINO 6 É O RX E O PINO 7 É O TX

char ssid[] = "Pablo Wifi"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "zoeeamora";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  Teste.begin(9600); //INICIALIZA A SERIAL PARA O ESP8266
  WiFi.init(&Teste); //INICIALIZA A COMUNICAÇÃO SERIAL COM O ESP8266
